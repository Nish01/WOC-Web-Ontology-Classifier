...
// @LINE:22
private[this] lazy val controllers_ApplicationBoth_chooseBoth8 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("choosefileBoth"))))
...
case controllers_ApplicationBoth_chooseBoth8(params) => {
   call { 
        invokeHandler(controllers.ApplicationBoth.chooseBoth(), HandlerDef(this, "controllers.ApplicationBoth", "chooseBoth", Nil,"GET", """""", Routes.prefix + """choosefileBoth"""))
   }
}
